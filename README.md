...
## Some advance topics (you should see in javascript online)

Some advance topics I am not covering here i.e. Regular expressions, prototypical inheritance, expressions, `null` and `undefined` and `NaN`, variable scope, built-in functions, browser/DOM functions, `this`, you should check them online.
